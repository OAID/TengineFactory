...
namespace TFactory {
MutiInputLine::MutiInputLine(/* args */)
{
}

void MutiInputLine::onCreate()
{
    if (inited) return;
    tengineHandler->createTengineTensor(dataHandler.get());
}

void MutiInputLine::onPreProcess()
{

}

void MutiInputLine::onRun(uint8_t* imageData, int input_w, int input_h, std::vector<std::vector<float*>> streams)
{
...
void MutiInputLine::setImageOutput()
{
...
void MutiInputLine::onPostProcess()
{
    clearBuffer();
    setStreamPostOutput();
...
void MutiInputLine::setStreamPostOutput()
{
...
std::vector<float*> MutiInputLine::onReceiveOutput()
{
    return outputBuffer;
}

void MutiInputLine::onDestory()
{
}

MutiInputLine::~MutiInputLine()
{
    clearBuffer();
}
}