 ...
 */
class Tengine_PUBLIC ImageProcess {
public:
    struct Inside;
    struct Config {
        /** data filter */
...
public:
     ...
     * @return result code.
     */
    ErrorCode convert(const uint8_t* source, int iw, int ih, int stride, void* dest, int ow, int oh, halide_type_t type = halide_type_of<uint8_t>());
